...
function removeVipPermissions($remove_name)
{
    ...
    try {
        if ($rcon->connect()) {
            ...
            $log_message =
                date("Y-m-d H:i:s") .
                " - Removed VIP permissions for user: $remove_name - Response: " .
                ($response ?: "No response") .
                "\n";
            file_put_contents("vip_rcon_log.txt", $log_message, FILE_APPEND);
