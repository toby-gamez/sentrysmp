...
try {
    $db = new SQLite3("eternal.sqlite");
    $result = $db->query(
        "SELECT id, username, created_at FROM eternal_users ORDER BY created_at DESC"
    );
...
<html>
    <head>
        ...
        <meta
            name="keywords"
            content="Minecraft, SMP, English, Czech, server, safe, enjoyable, experience, players, eternal, premium, exclusive"
        />
        ...
        <title>Eternal Manager - Admin - Sentry SMP</title>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <div class="container">
            <div class="main-wrapper">
                <h2 class="main">Eternal Manager</h2>
            </div>
            ...
            <?php else: ?>
                <p>No Eternal waiting users found.</p>
            <?php endif; ?>
        </div>
