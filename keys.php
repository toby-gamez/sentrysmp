...
$db->exec("ALTER TABLE Keys ADD COLUMN price INTEGER DEFAULT 3;");

$results = $db->query("SELECT * FROM Keys");
    ...
    <body>
        ...
        <div class="container">
            <div class="main-wrapper">
                <h1 class="main">Keys</h1>
            </div>
            <div class="spawner-grid">
                <?php while ($row = $results->fetchArray(SQLITE3_ASSOC)): ?>
                    <div class="spawner" data-id="key_<?= $row["id"] ?>">
                        ...
                        <div class="cart-controls">
                            ...
                            <button onclick="addToCart(this, 'key_<?= $row[
                                "id"
