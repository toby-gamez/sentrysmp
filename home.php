...
error_log("home.php: Loaded " . count($announcements) . " announcements");
if (count($announcements) > 0) {
    error_log("home.php: First announcement: " . $announcements[0]["title"]);
} else {
    error_log("home.php: No announcements loaded - check Discord API");
}
?>
<!doctype html>
<html>
